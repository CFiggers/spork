...
# `date/date?` and `date/duration?`

(assert (= (date/date? (os/date 1734364168))
           {:dst false :hours 15 :minutes 49 :month 11 :month-day 15 :seconds 28 :week-day 1 :year 2024 :year-day 350}))
(assert (= (date/duration? (os/date 1734364168))
           {:dst false :hours 15 :minutes 49 :month 11 :month-day 15 :seconds 28 :week-day 1 :year 2024 :year-day 350}))

(assert (= (try (date/date? (thaw (os/date))) ([_] "errored")) "errored"))
(assert (= (try (date/duration? (thaw (os/date))) ([_] "errored")) "errored"))
...
(assert (= (date/compare {:year 0 :year-day 0 :hours 2 :minutes 0 :seconds 0}
                         {:year 0 :year-day 0 :hours 2 :minutes 0 :seconds 0}) 0))
(assert (= (date/compare {:year 0 :year-day 0 :hours 2 :minutes 0 :seconds 0}
                         {:year 0 :year-day 0 :hours 3 :minutes 0 :seconds 0}) -1))
(assert (= (date/compare {:year 0 :year-day 0 :hours 3 :minutes 0 :seconds 0}
                         {:year 0 :year-day 0 :hours 2 :minutes 0 :seconds 0}) 1))
...
(assert (= (date/from-string "08/22" "MM/dd")
           {:dst false :hours 0 :minutes 0 :month 7 :month-day 21 :seconds 0 :week-day 2 :year 0 :year-day 234}))
...
(assert (= (date/sub date-2024-01-01 :seconds 900000000000)
           {:dst false :hours 8 :minutes 0 :month 1 :month-day 19 :seconds 0 :week-day 6 :year -26496 :year-day 50}))

# `date/sub` with negative values
...
(assert (= (date/sub date-2024-01-01 :seconds -900000000000)
           {:dst false :hours 16 :minutes 0 :month 10 :month-day 11 :seconds 0 :week-day 2 :year 30543 :year-day 315}))
...
(assert (= (date/diff (date/from-string "1991-08-27" "yyyy-MM-dd")
           ...
           {:dst false :hours 0 :minutes 0 :month 8 :month-day 10 :seconds 0 :week-day 0 :year -34 :year-day 253}))
(assert (= (date/diff (date/from-string "2024-12-17" "yyyy-MM-dd")
                      (date/from-string "1991-08-27" "yyyy-MM-dd"))
           {:dst false :hours 0 :minutes 0 :month 3 :month-day 20 :seconds 0 :week-day 4 :year 33 :year-day 110}))
(assert (= (date/duration? (date/diff (date/from-string "2024-12-17" "yyyy-MM-dd")
                                      (date/from-string "1991-08-27" "yyyy-MM-dd")))
           {:dst false :hours 0 :minutes 0 :month 3 :month-day 20 :seconds 0 :week-day 4 :year 33 :year-day 110}))
(assert (= (date/diff (date/from-string "2024-12-17" "yyyy-MM-dd")
                      (date/from-string "1998-07-14" "yyyy-MM-dd"))
           {:dst false :hours 0 :minutes 0 :month 5 :month-day 3 :seconds 0 :week-day 4 :year 26 :year-day 154}))
(assert (= (date/duration? (date/diff (date/from-string "2024-12-17" "yyyy-MM-dd")
                                      (date/from-string "1998-07-14" "yyyy-MM-dd")))
           {:dst false :hours 0 :minutes 0 :month 5 :month-day 3 :seconds 0 :week-day 4 :year 26 :year-day 154}))
